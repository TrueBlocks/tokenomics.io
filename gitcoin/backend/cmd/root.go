...
var helpText = `  General:
    produce       produce grants data for ui
    summarize     produce summary data
    download      download monitor data from server
  Group 2:
    cmd1          reserved for future use
    cmd2          reserved for future use
  Flags:
