...
import (
	...
	monPkg "github.com/TrueBlocks/tokenomics.io/gitcoin/backend/pkg/types/monitors"
...
type Grant struct {
	...
	Monitor                       monPkg.Monitor `json:"monitor"`
}
type Grants []Grant
...
func GetMonitorStats(grantId string, grant *Grant) (*monPkg.Monitor, error) {
	monitor := &monPkg.Monitor{Address: grant.AdminAddress}
